...
namespace Flash
{
	...
	public class BitmapData
	{
		...
		public void colorTransform(Rectangle rect, ColorTransform colorTransform)
		{
			...
			float redOffset = colorTransform.redOffset;
			float greenOffset = colorTransform.greenOffset; 
			float blueOffset = colorTransform.blueOffset;
			float alphaOffset = colorTransform.alphaOffset;
